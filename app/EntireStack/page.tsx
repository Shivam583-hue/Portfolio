import { AWSIcon, ClerkIcon, DockerIcon, DrizzleIcon, ExpoIcon, GoIcon, JavaScriptIcon, JWTIcon, KafkaIcon, KubernetesIcon, MongoDbIcon, MySqlIcon, NeovimIcon, NextIcon, PostgresIcon, PrismaIcon, Railway, RedisIcon, RustIcon, SupabaseIcon, TailwindIcon, TRPCicon, TypescriptIcon, VercelIcon } from "./Icons"
    ...
    <div>
      <div className="pl-8 sm:pl-24 md:pl-64">
        ...
        <div className="flex-wrap flex gap-2">
          ...
          />
          <Component Icon={<RustIcon />}
            Label={<h1 className="text-black font-mono text-xl font-semibold pr-16 pt-3.5">Rust</h1>} />
        </div>
        <div className=" pt-8 pb-4">
        ...
        <div className="flex-wrap flex gap-2">
          ...
          />
          <Component Icon={<ExpoIcon />}
            Label={<h1 className="text-black font-mono text-xl font-semibold pr-14 pt-3.5">Expo</h1>}
          />
          <Component Icon={<RustIcon />}
            Label={<h1 className="text-black font-mono text-xl font-semibold pr-14 pt-3.5">Axum</h1>}
          />
          <Component Icon={<GoIcon />}
            Label={<h1 className="text-black font-mono text-xl font-semibold pr-16  pt-3 md:pt-3.5">Chi</h1>}
          />
        </div>
        <div className=" pt-8 pb-4">
        ...
        <div className="flex-wrap flex gap-2">
          ...
          />
          <Component Icon={<KafkaIcon />}
            Label={<h1 className="text-black font-mono text-lg pr-14 font-semibold  pt-3.5">Kafka</h1>}
          />
      ...
      <div className="mt-8 py-4 bg-gray-800 text-white text-center rounded-md">
        <p className="text-lg font-mono">and more things im too lazy to add</p>
      </div>
    </div>
